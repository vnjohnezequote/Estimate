...
namespace AppModels.ResponsiveData
{
    ...
    public class WallLayer : WallBase, IComparable<WallLayer>
    {
        ...
        public int SubStud
        {
            get
            {
                if (this.TimberWallTypePoco.IsLoadBearingWall || this.TimberWallTypePoco.IsRaked || this.IsRakedArea || this.PitchingHeight.Size < this.DefaultInfo.InternalWallHeight)
                {
                    return 0;
                }
                else
